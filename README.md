...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">16. Create Courses Using Voice Recording</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Do I need any technical skills to use CourseReel AI MAX?</h3>
<!-- /wp:heading -->
